    ...
    <section className={s.layout_custom}>
        <div className={s.container}>
            ...
            <div className={s.sketchingImg}>
                <Image  src={content.img[3]} alt='img' width={0} height={0} sizes='100vw' style={{height:'auto',width:'100%'}} />
            </div>
            ...
            <div className={s.experimentationImg1}>
                <Image  src={content.img[5]} alt='img' width={0} height={0} sizes='100vw' style={{height:'auto',width:'100%'}} />
            </div>
            <div className={s.experimentationImg2}>
                <Image  src={content.img[4]} alt='img' width={0} height={0} sizes='100vw' style={{height:'auto',width:'100%'}} />
            </div>
            ...
            <div className={s.prototypingImg}>
                <Image  src={content.img[2]} alt='img' width={0} height={0} sizes='100vw' style={{height:'auto',width:'100%'}} />
            </div>
        </div>
        <div className={s.experimentationImg3}>
                <Image  src={content.img[1]} alt='img' width={0} height={0} sizes='100vw' style={{height:'auto',width:'100%'}} />
        </div>
    </section>
  )
}
