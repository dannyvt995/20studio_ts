...
export default function Layout_2() {
  return (
    <section className='POST_layout2 has_padding_top_and_bottom dark_background'>
        <div className={s.container}>
            <h2 className={s.title}>
                <div className='title-mask'>
                    <span className='title_line'>Stellar</span>
                    </div>
                    <div className='title-mask'>
                    <span className='title_line'>Partnership</span>
            </div>
            </h2>
