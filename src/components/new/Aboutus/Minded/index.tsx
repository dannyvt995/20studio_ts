...
export default function Minded() {
    return (
        <section className={cn(s.aboutus_minded,s.light_background)}>
            ...
            <div data-v-513a4b54="" className={s.image} style={{clipPath: "polygon(6.68% 0px, 93.32% 0px, 93.32% 100%, 6.68% 100%)"}}>
            <Image
                ...
                <div data-v-513a4b54="" className={s.background}>
                    <div data-v-513a4b54="" className={s.dark}></div> 
                    <div data-v-513a4b54="" className={s.light}></div>
                </div>
        </section>
    )
}
